 ...
 * @author Santos
 */
public class VerificarConeccion extends javax.swing.JFrame {

    /**
     * Creates new form VerificarConeccion
     */
    Conectar con;
    public VerificarConeccion() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerificarConeccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerificarConeccion().setVisible(true);
            }
        });
    }
