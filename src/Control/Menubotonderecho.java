 ...
 * @author Santos
 */
public class Menubotonderecho extends JPopupMenu {
    ...
    public static void addMenubotonderecho(JTextComponent component)
    {
        Menubotonderecho defaultContextMenu = new Menubotonderecho();
        defaultContextMenu.addTo(component);
    }
     public static void addMenubotonderecho(JTable component) {
       Menubotonderecho defaultContextMenu = new Menubotonderecho();
        defaultContextMenu.addTo(component);
    }
